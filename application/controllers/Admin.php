...
class Admin extends CI_Controller {
    ...
    public function profile(){
     ...
     // public function fetch_single_barang(){
    //     $output = array();
    //     $this->Barang_model->get_satu_barang($_POST["id"]);
    //     foreach($data as $row)
    //     {
    //         $output['id_jenis_barang'] = $row->nama_jenis_barang;
    //         $output['nama_barang'] = $row->nama_barang;
    //         $output['jumlah_barang'] = $row->jumlah_barang;
    //         $output['satuan'] = $row->satuan;
    //         $output['status_submisi'] = $row->status_submisi;
